...
const splashPages = require("./splash-pages.routes");
const linkPreviews = require("./link-previews.routes");
...
apiRouter.use("/splash-pages", splashPages);
apiRouter.use("/link-previews", linkPreviews);
